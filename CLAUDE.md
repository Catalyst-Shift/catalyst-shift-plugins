...
<!-- Ways of Working canon. Synced copies live in: each repo's CLAUDE.md, the
HQ project custom instructions, and the catalyst-ops plugin's ways-of-working
skill. Change via ONE Linear issue that updates all surfaces. Last synced:
2026-08-28. -->
